...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-8">
        <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl shadow-xl p-6 mb-12 text-center">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-3">Temukan Barang Hilang Anda</h1>
            <p class="text-indigo-100 max-w-2xl mx-auto text-lg">
                Cari melalui barang hilang dan temuan menggunakan kata kunci atau unggah gambar untuk pencarian dengan AI
            </p>
        </div>
                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            <p class="text-indigo-700 dark:text-indigo-300 mb-4">
                                Cari barang yang Anda hilangkan di kampus
                            </p>
                            <form id="lost-search-form" class="flex flex-col sm:flex-row gap-3">
                                <div class="flex-1 relative">
                                    <input type="text" id="search-lost" placeholder="Cari barang hilang..."
                            ...
                            <form action="{{ route('search.by.image') }}" method="POST" enctype="multipart/form-data" class="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg">
                                ...
                                <div class="flex flex-col md:flex-row gap-4 items-center">
                                    <div class="flex-1 w-full">
                                        <label class="block mb-1 text-sm font-medium text-indigo-700 dark:text-indigo-300">Unggah gambar barang</label>
                                        <div class="flex items-center justify-center w-full">
                                            <label class="flex flex-col w-full border-2 border-dashed border-indigo-300 dark:border-indigo-600 hover:border-indigo-400 rounded-lg cursor-pointer">
                                                <div class="flex flex-col items-center justify-center py-6">
                                                    ...
                                                    <p class="text-xs text-indigo-400 dark:text-indigo-500">PNG, JPG hingga 2MB</p>
                                                </div>
                        ...
                        <div id="lost-container" class="hidden mt-6">
                            ...
                            <p class="text-center text-gray-500 mt-4 hidden no-results">Tidak ada barang hilang yang cocok ditemukan</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            <p class="text-green-700 dark:text-green-300 mb-4">
                                Cari barang yang ditemukan oleh orang lain
                            </p>
                            <form id="found-search-form" class="flex flex-col sm:flex-row gap-3">
                                <div class="flex-1 relative">
                                    <input type="text" id="search-found" placeholder="Cari barang temuan..."
                        ...
                        <div class="mb-6">
                            ...
                            <form action="{{ route('search.by.image') }}" method="POST" enctype="multipart/form-data" class="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg">
                                ...
                                <div class="flex flex-col md:flex-row gap-4 items-center">
                                    <div class="flex-1 w-full">
                                        <label class="block mb-1 text-sm font-medium text-green-700 dark:text-green-300">Unggah gambar barang</label>
                                        <div class="flex items-center justify-center w-full">
                                            <label class="flex flex-col w-full border-2 border-dashed border-green-300 dark:border-green-600 hover:border-green-400 rounded-lg cursor-pointer">
                                                <div class="flex flex-col items-center justify-center py-6">
                                                    ...
                                                    <p class="text-xs text-green-400 dark:text-green-500">PNG, JPG hingga 2MB</p>
                                                </div>
                                                <input type="file" name="vision_image" accept="image/*" required class="hidden">
                                            </label>
                                        </div>
                        ...
                        <div id="found-container" class="hidden mt-6">
                            ...
                            <p class="text-center text-gray-500 mt-4 hidden no-results">Tidak ada barang temuan yang cocok ditemukan</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-start gap-3 mb-4">
                        ...
                        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Tips untuk Pencarian Gambar</h2>
                    </div>

                    <ul class="space-y-3">
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-indigo-600 dark:text-indigo-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Pastikan barang dalam fokus yang jelas — hindari gambar buram</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-indigo-600 dark:text-indigo-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Gunakan pencahayaan yang baik untuk membuat detail terlihat</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-indigo-600 dark:text-indigo-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Tengah-tengahkan barang dan hindari latar belakang yang berantakan</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-indigo-600 dark:text-indigo-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Unggah format PNG atau JPG (maksimal 2MB)</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-indigo-600 dark:text-indigo-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Hindari menyertakan wajah manusia atau objek yang tidak terkait</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-indigo-600 dark:text-indigo-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Ambil dari jarak yang wajar untuk pengenalan</span>
                        </li>
                    </ul>

                    <div class="mt-4 p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                        <p class="text-sm text-indigo-700 dark:text-indigo-300">
                            Mengikuti tips ini akan meningkatkan akurasi pengenalan AI hingga 70%
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-start gap-3 mb-4">
                        ...
                        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Mencari Barang Anda</h2>
                    </div>

                    <ul class="space-y-3">
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-green-600 dark:text-green-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Gunakan gambar yang sesuai dengan kondisi barang yang mungkin</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-green-600 dark:text-green-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Pencahayaan alami bekerja paling baik untuk warna yang akurat</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-green-600 dark:text-green-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Tengah-tengahkan barang dengan gangguan minimal</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-green-600 dark:text-green-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Unggah format PNG atau JPG (maksimal 2MB)</span>
                        ...
                        <li class="flex items-start gap-2">
                            <span class="mt-0.5 text-green-600 dark:text-green-400">✓</span>
                            <span class="text-gray-700 dark:text-gray-300">Hindari selfie atau gambar dengan orang</span>
                        </li>
                    </ul>

                    <div class="mt-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                        <p class="text-sm text-green-700 dark:text-green-300">
                            Gambar yang jelas meningkatkan tingkat keberhasilan kecocokan sebesar 60%
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl w-11/12 max-w-lg mx-auto shadow-2xl transform transition-transform duration-300 scale-95 opacity-0"
            ...
            <div class="px-6 py-5 space-y-4">
                <p class="text-gray-700 dark:text-gray-300">
                    Kami mengidentifikasi karakteristik berikut dalam gambar Anda:
                </p>
                ...
                <div class="mt-4">
                    <label for="selected_label_modal" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Pilih label yang paling relevan:
                    </label>
                    <form id="aiOverrideForm" action="{{ session('last_item_id') ? route('items.updateLabel', session('last_item_id')) : '#' }}" method="POST">
                        ...
                        <select name="selected_label" id="selected_label_modal" required
                            ...
                            <option value="" disabled selected>Pilih kecocokan terbaik...</option>
                            @foreach(session('image_labels') ?? [] as $label)
        ...
        document.addEventListener('DOMContentLoaded', function () {
            function setupSearch(formId, inputId, containerId) {
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    if (!keyword) {
                        showToast('Harap masukkan kata kunci pencarian');
                        return;
                    }
                    ...
                    if (visibleCount === 0) {
                        showToast('Tidak ada item yang cocok ditemukan');
                    }
                });
            }
